...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {353171541,456050586,000000,000000,000000,000000},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..RADICALBOTTEAM..'/data/moderation.json'},
    info_text = [[*RADICALBOT Helper Bot V3.1*

》[RADICALBOT Helper](https://github.com/RadikalBotTeam/MaTaDoR)

*》Admins :*
*》Founder & Developer :* [ArIaSuDo](Telegram.Me/ariasudo)
